...
│   └── duplicate_findings_insights.md
│
├── docs/
│   ├── images/
│   │   ├── workflow-history.png
│   │   ├── full-pipeline-execution.png
│   │   ├── unified-security-dashboard.png
│   │   └── codeql-dataflow-analysis.png
│   │
│   └── report/
...
| `scripts/compare_sarif.py` | SARIF normalization and comparative analysis framework |
| `scripts/generate_duplicate_data.py` | Duplicate cluster and overlap analysis utility |
| `sarif_reports/` | Input SARIF reports generated by CodeQL and Semgrep |
| `comparison_output/` | Generated datasets, duplicate analysis tables, and analytical evaluation reports |
